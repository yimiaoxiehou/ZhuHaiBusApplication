...
public class BusAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public BusAdapter1(Context context,List textIdList){
    ...
    public static class BusItemViewHolder extends RecyclerView.ViewHolder{
        ...
        public BusItemViewHolder(View view){
            super(view);
            bustext=(TextView)view.findViewById(R.id.bus_text1);
        }
    }
