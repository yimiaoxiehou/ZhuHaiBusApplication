...
public class BusRouteOverlay extends RouteOverlay {
    ...
    private void addRailwayStep(RouteRailwayItem railway) {
        ...
        List<RailwayStationItem> railwayStationItemList = new ArrayList<RailwayStationItem>();
        railwayStationItemList.add(railway.getDeparturestop());
        railwayStationItemList.addAll(railway.getViastops());
        railwayStationItemList.add(railway.getArrivalstop());
        railwayStationItemList.forEach(r->{
            railWayListPoint.add(AMapUtil.convertToLatLng(r.getLocation()));
        });
